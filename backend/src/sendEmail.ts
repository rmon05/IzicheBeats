...
const createRawMessage = (sender, recipient, subject, text, title:string, base64File:string) => {
...
export const sendRawEmail = async (sender, recipient, subject, text, title:string, base64File : string) => {
    try {
        const params = {
            RawMessage: {
